...
"#;
        ...
        match last {
            ...
            1 => prop_assert_eq!(
                ...
                Some(sbol::Severity::Error),
                "deny should promote to Error"
            ),
            _ => prop_assert_eq!(
                issue.map(|i| i.severity),
                Some(sbol::Severity::Warning),
...
proptest! {
    ...
    fn coverage_partitions_catalog_for_every_external_mode(mode_index in 0u8..3) {
        ...
        let mode = match mode_index {
            0 => sbol::ExternalValidationMode::Off,
            1 => sbol::ExternalValidationMode::ProvidedOnly,
            _ => sbol::ExternalValidationMode::ExternalAllowed,
        };
        let context = sbol::ValidationContext::new().with_external_mode(mode);
        ...
        prop_assert_eq!(seen.len(), sbol::validation_rule_statuses().len());
    }
}
