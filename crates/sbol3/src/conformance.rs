...
fn render_profile_section(out: &mut String) {
    ...
    out.push_str("- **Structural import / export**: Turtle parse and serialize for the SBOLTestSuite fixture corpus is exercised by `representative_fixtures_round_trip_as_normalized_rdf` in `crates/sbol3/tests/sbol3_fixtures.rs`.\n");
    ...
    out.push_str("- **Property-based testing**: `crates/sbol3/tests/properties.rs` exercises eight spec-derived properties under `proptest` at the default case count, including catalog coverage partitioning and override-builder semantics.\n");
