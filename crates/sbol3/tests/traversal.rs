...
fn build_doc() -> (Document, /* component identity */ sbol3::Resource) {
    ...
    let sequence = sbol3::Sequence::new("https://example.org/lab", "seq").unwrap();
    ...
    let sf_identity = sbol3::Resource::iri("https://example.org/lab/owner/sf1");
    let range = sbol3::Range::builder(&sf_identity, "r")
        .unwrap()
        .start(1)
        .end(100)
    ...
    let constraint = sbol3::Constraint::new(
        &owner.identity,
        "k1",
        sub.identity.clone(),
        sf.identity.clone(),
    ...
    let variable_feature = sbol3::VariableFeature::new(
        &sbol3::Resource::iri("https://example.org/lab/cd"),
        "vf",
...
fn unresolved_references_are_silently_skipped() {
    ...
    let mut interaction = Interaction::new(
        &sbol3::Resource::iri("https://example.org/lab/c"),
        "i1",
    ...
    interaction
        .participations
        .push(sbol3::Resource::iri("https://example.org/missing"));
