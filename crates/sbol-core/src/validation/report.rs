//! Structured validation diagnostics: severities, issues, per-rule coverage,
//! and the report that a validator produces.
...
pub struct AppliedOptions {
    ...
    pub overridden_rules: Vec<(&'static str, RuleOverride)>,
...
pub struct ValidationReport {
    ...
    options_summary: AppliedOptions,
}

impl ValidationReport {
    /// Assemble a report from its parts. Validators build the issue list,
    /// coverage, and options summary separately and combine them here.
    pub fn from_parts(
        issues: Vec<ValidationIssue>,
        coverage: RuleCoverage,
        options_summary: AppliedOptions,
